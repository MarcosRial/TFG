...
\begin{frame}
	\begin{columns}
		\begin{column}{5cm}
			{\footnotesize 4-3-2}
			\only<1->{\includegraphics[width=\linewidth]{./Imagenes/GF432.png}}\\
			\vspace*{0.5cm}
			\only<2->{{\footnotesize 5-4-3}}
			\only<2->{\includegraphics[width=\linewidth]{./Imagenes/GF543.png}}
		\end{column}
		\begin{column}{5cm}
			\only<3->{{\footnotesize 5-6-2}}
			\only<3->{\includegraphics[width=\linewidth]{./Imagenes/GF562.png}}\\
			\only<4->{{\footnotesize 6-5-4}}
			\only<4->{\includegraphics[width=\linewidth]{./Imagenes/GF654.png}}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	\begin{columns}
		\begin{column}{5cm}
			{\footnotesize Clasificación no supervisada}
			\only<1->{\includegraphics[width=0.7\linewidth]{./Imagenes/Detalle_clasnosup.png}}\\
			\vspace*{0.1cm}
			\only<2->{{\footnotesize Clasificación supervisada}}
			\only<2->{\includegraphics[width=0.7\linewidth]{./Imagenes/Detalle_classup.png}}
		\end{column}
		\begin{column}{5cm}
			\only<3->{{\footnotesize Spectral Anlge Mapper}}
			\only<3->{\includegraphics[width=\linewidth]{./Imagenes/Detalle_SAM.png}}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	\begin{columns}
		\begin{column}{5cm}
			{\footnotesize NDVI}\\
			\only<1->{\includegraphics[width=\linewidth]{./Imagenes/Detalle_aguas.png}}
		\end{column}
		\begin{column}{5cm}
			\only<2>{\footnotesize SAVI}\\
			\only<2>{\includegraphics[width=\linewidth]{./Imagenes/Detalle_estanques.png}}
		\end{column}
	\end{columns}
\end{frame}
