...
En las clasificaciones se muestra confusión de clases, mezclándose en algunos casos el mangle con otro tipo de vegetación. A excepción de la clasificación supervisada que, a pesar de que se ve un exceso de la clase denominada ``Agua 2'' en zonas donde no hay presencia de esta, discrimina bien la cobertura de mangle de otros tipos.\Sep

Se muestra el resultado de las clasificaciones en el anexo de mapas de este documento.
...
Se muestra el resultado de los índices de vegetación en el anexo de mapas de este documento.