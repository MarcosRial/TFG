...
Los gráficos de barras extraídos de la base de datos de la capa ``puntos'' de GRASS es la mostrada en la figura ..... En ellos se muestra el valor que devuelve el raster de cada banda en cada punto. Se muestran los valores en el cuadro  \ref{tab:tabla_puntos}.
